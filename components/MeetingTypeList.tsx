...
const MeetingTypeList = () => {
    ...
    return (
        <section className=" h-screen flex size-full flex-col gap-10 text-white overflow-y-hidden">
            ...
            <div className='h-1/3 w-full flex justify-center items-center gap-10'>
                <div className='h-full w-3/5  rounded-xl border-black' onClick={() => { setMeetingState("isScheduleMeeting") }}>
                    <HomeCard
            ...
            {!callDetails ? (
                ...
                >
                    <div className='flex flex-col gap-2.5'>
                        <label className='text-base text-noraml leading-[22px] text-sky-2'>Add a description</label>
                    ...
                    <div className='flex w-full flex-col gap-2.5'>
                        <label className='text-base text-noraml leading-[22px] text-sky-2'>Select Date And Time</label>
                        <ReactDatePicker
